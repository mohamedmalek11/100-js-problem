...
// true xor true == false // Both are true.  "xor" only returns true if EXACTLY one of
//  the two expressions evaluate to true.
...
//  Your xor function should have the behaviour described above, returning true if exactly one
